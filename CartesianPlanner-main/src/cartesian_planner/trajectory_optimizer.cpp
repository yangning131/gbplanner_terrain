...
bool TrajectoryOptimizer::FormulateCorridorConstraints(States &states, Constraints &constraints) {
  ...
  for (size_t i = 0; i < config_.nfe; i++) {
    ...
    visualization::PlotPolygon(math::Polygon2d(math::Box2d(box_ploy)),  states.z[i], 0.02, visualization::Color::Cyan, i,
                               "Front Corridor");
    ...
    visualization::PlotPolygon(math::Polygon2d(math::Box2d(box_ploy1)),  states.z[i], 0.02, visualization::Color::Cyan, i, "Rear Corridor");
  }
