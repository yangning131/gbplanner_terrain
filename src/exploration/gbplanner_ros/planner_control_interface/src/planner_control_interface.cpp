...
planner_goal_pub_ =
      nh_.advertise<geometry_msgs::Pose>("local_goal1", 5);
...
// waypoint 设置
  pci_to_waypoint_server_ = nh_.advertiseService(
      "goToWaypointCallback", &PlannerControlInterface::goToWaypointCallback, this);
...
bool PlannerControlInterface::goToWaypointCallback(
 ...
 ROS_INFO("test8888888888888888888888.");
  return true;
}
