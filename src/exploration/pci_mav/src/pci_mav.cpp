...
bool PCIMAV::initMotion() {
  ...
  nav_msgs::Path  path_ex;
  geometry_msgs::PoseStamped temp_pose;
  geometry_msgs::PoseStamped pub_temp_pose;
  
  pub_temp_pose.header.frame_id="map";
  pub_temp_pose.header.stamp = ros::Time::now();
  pub_temp_pose.header.seq=0;
  ...
  path_ex.header.stamp = ros::Time::now();
  path_ex.header.seq = 0;
  path_ex.header.frame_id = "map";
  ...
  num_pose=i;
  temp_pose.pose.position.x = path_new[i].position.x;
  temp_pose.pose.position.y = path_new[i].position.y;
  temp_pose.pose.position.z = path_new[i].position.z;  //change

    temp_pose.pose.orientation.x = path_new[i].orientation.x;
    temp_pose.pose.orientation.y = path_new[i].orientation.y;
    temp_pose.pose.orientation.z = path_new[i].orientation.z;
    temp_pose.pose.orientation.w = path_new[i].orientation.w;
     pose_array.poses.push_back(temp_pose.pose);
     path_ex.poses.push_back(temp_pose);
  ...
  pub_temp_pose.pose.position.x = path_new[num_pose].position.x;
  pub_temp_pose.pose.position.y = path_new[num_pose].position.y;
  pub_temp_pose.pose.position.z = 0;

    pub_temp_pose.pose.orientation.x = path_new[num_pose].orientation.x;
    pub_temp_pose.pose.orientation.y = path_new[num_pose].orientation.y;
    pub_temp_pose.pose.orientation.z = path_new[num_pose].orientation.z;
    pub_temp_pose.pose.orientation.w = path_new[num_pose].orientation.w;
    /*tttttttttttttttttttttt*/
...
PCIMAV::generateTrajectoryMarkerArray(//***********************************************************
  ...
  path_ex.header.stamp = traj.header.stamp;
  path_ex.header.seq = traj.header.seq;
  path_ex.header.frame_id = "map";
...
// 
  ...
  num_waypoint=i;
    ...
    temp_pose.pose.position.x = ti_v3.x;
    temp_pose.pose.position.y = ti_v3.y;
   
    // temp_pose.pose.position.z = 0;
    temp_pose.pose.position.z = ti_v3.z; //change
    ...
    temp_pose.pose.orientation.x=ti_q.x;
    temp_pose.pose.orientation.y=ti_q.y;
    temp_pose.pose.orientation.z=ti_q.z;
    temp_pose.pose.orientation.w=ti_q.w;
  ...
  temp_pose.pose.position.x = tb_v3.x;
  temp_pose.pose.position.y = tb_v3.y;
  temp_pose.pose.position.z = tb_v3.z; //change
  ...
  temp_pose.pose.orientation.x=tb_q.x;
  temp_pose.pose.orientation.y=tb_q.y;
  temp_pose.pose.orientation.z=tb_q.z;
  temp_pose.pose.orientation.w=tb_q.w;
...
/***************/
  pub_temp_pose.pose.position.x = temp_pose.pose.position.x;
  pub_temp_pose.pose.position.y = temp_pose.pose.position.y;
  pub_temp_pose.pose.position.z = 0;

  pub_temp_pose.pose.orientation.x = temp_pose.pose.orientation.x;
  pub_temp_pose.pose.orientation.y = temp_pose.pose.orientation.y;
  pub_temp_pose.pose.orientation.z = temp_pose.pose.orientation.z;
  pub_temp_pose.pose.orientation.w = temp_pose.pose.orientation.w;
/*********************/
  local_goal_pub_.publish(pub_temp_pose);
  waypoint_list_pub_.publish(pose_array);
  path_pub_.publish(path_ex);
